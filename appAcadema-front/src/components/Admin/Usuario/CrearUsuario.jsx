...
import { getAllProfesores } from "../../../services/profeService";
                ...
                <div className="bg-color1 w-full max-w-md rounded-[2rem] p-8 shadow-2xl border-4 border-white transform transition-all overflow-y-auto max-h-[90vh]">
                    ...
                    <form onSubmit={handleGuardar} className="flex flex-col gap-3">
                        ...
                        <div className="flex justify-between items-center mt-8 gap-4">
                            <button 
                                type="button" 
                                className="bg-color2 text-color5 font-bold py-3 px-8 rounded-2xl hover:bg-opacity-80 transition-all flex-1"
                                onClick={onClose}
                            >
                                Cancelar
                            </button>
                            <button 
                                type="submit"
                                className="bg-color3 text-white font-bold py-3 px-8 rounded-2xl hover:bg-opacity-90 transition-all flex-1 shadow-md"
                            >
                                Enviar
                            </button>
                        </div>
